...
#warning "Pixel format should be inverted for iOS and Android!!!"
			pixel = (clrconv->invert) ? RGB32(red, green, blue) : BGR32(red, green, blue);
			*dst32 = pixel;
			dst32++;
		}
...
#warning "Pixel format is changed for iOS and Android!!!"
                        int index;
                        int red, green, blue;
                        ...
                        {
                            /*
                             * XXX It's ABGR here but DirectFB just works perfectly with ARGB, why?
                             */
                            red = *(srcData++);
                            green = *(srcData++);
                            blue = *(srcData++);
