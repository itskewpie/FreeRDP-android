...
#define VIRTUALCHANNELENTRY(_prefix) _prefix##_VirtualChannelEntry
#else
#define VIRTUALCHANNELENTRY(_prefix) VirtualChannelEntry
#endif

#define DEFINE_SVC_PLUGIN(_prefix, _name, _options) \
\
int VIRTUALCHANNELENTRY(_prefix)(PCHANNEL_ENTRY_POINTS pEntryPoints) \
{ \
	_prefix##Plugin* _p; \
\
